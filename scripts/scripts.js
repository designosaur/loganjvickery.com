...
var galleryContent = {
  ...
  // project content
  papajohn: '<h2>EthicsPoint Web Intake Site for Papa John\'s</h2><p>During my tenure at NAVEX Global I developed and edited countless websites for small and large companies from around the world.  Here is one such site that I created from a mock-up. It feautures a custom search function that AJAX\'s a JSON database of store locations and returns a store number match.<br><br><a target="_blank" href="https://secure.ethicspoint.com/domain/media/en/gui/42086/index.html">Visit the live site</a></p><br><br><img class="gal_img" src="work/papajohn.jpg">',
  alexandria: '<h2>Alexandria - Dev Code Library</h2><p>In my last role I created 7 new dev tools and made enhancements to 7 already existing dev tools. One of the last tools I created was a code library where teammates could share commonly used code snippets. This was especially helpful for new teammates. I also created an encoder to make adding new snippets easier by converting the input data into object format and encoding things like line breaks and tabs to a single string format.<br><br><a target="_blank" href="https://secure.ethicspoint.com/domain/media/en/gui/49898/codelibrary.html">Visit the live site</a></p><br><br><img class="gal_img" src="work/alexandria.jpg">',
  formatter: '<h2>HTML Formatter</h2><p>This is a tool I created for an empoyer to increase efficiency and reduce the monotony of converting text from Word docs (or other sources) to an HTML format. Text that is copied and pasted into the top text area is wrapped in paragraph tags. The tags can then be changed to any other desired type by selecting another type of tag and clicking on a block of text in the lower output area. Custom classes or other attributes can be added as well using the custom text box.<br><br><a href="/formatter/html_formatter.html">Click here to try it out</a></p><br><br><img class="gal_img" src="work/formatter.jpg">',
